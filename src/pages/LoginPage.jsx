...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md glass p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] relative z-10">
        <div className="text-center mb-8 sm:mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm sm:text-base">Sign in to Studynest NE Admin</p>
        </div>
